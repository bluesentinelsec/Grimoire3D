...
from grimoire3d.logic.window import get_effective_window_settings
from grimoire3d.logic.scaling import Viewport, get_virtual_resolution
...
def open_and_run(
    ...
    *,
    ...
    caption = title.value if title is not None else "Grimoire3D"
