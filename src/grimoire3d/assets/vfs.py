...
The single source of truth for all asset loading in Grimoire3D.
...
- Zip archives, optionally obfuscated with a simple password-based cipher (prod)
  Use :mod:`grimoire3d.assets.archive` to create such archives.
- In-memory byte arrays (embedded resources, tests, runtime data)

Typical usage::

    from grimoire3d.assets.vfs import VFS, DirProvider, ZipProvider, MemoryProvider
