...
See design-goals.md for platform support (Windows AMD64, Linux AMD64, macOS ARM — Steam-focused), runtime options, professional persistence, VFS + hot reload for data, flagship dynamic lighting/fog/GPU particles, dual-use GUI, direct TCP multiplayer, and the requirement to keep data model, business logic, and presentation clearly separated.
